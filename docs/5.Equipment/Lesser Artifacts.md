...
A small spider figurine which is placed on an open wound, where it quickly covers itself and the wound in a web that heals 1 wound over the course of 8 hours. The spider cannot heal damage from poison or other internal injuries. At the end of the healing roll a d6. On a 1 the spider has reached the end of its power, otherwise the spider creeps up from the wound to be reused on new ones. The creature treated by the healing spider suffers one point of temporary Corruption.
