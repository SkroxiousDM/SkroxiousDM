...
- If a creature reaches 6 levels of exhaustion, they gain two wound levels. Any additional Exhaustion counts as two wound levels.
# Frightened
A creature that is frightened is frightened _by_ the source of their fear, which is usually a creature, but could be an object or something else. 
...
# Goaded
A creature that is goaded is goaded _by_ a specific entity, which is usually a creature, but could be an object or something else.
...
- If grappled by a creature (rather than a spell or other ability), they can replace one of their weapon attacks on their turn with an escape attempt. make a Dexterity or Strength Saving Throw against the grapple’s escape DC at the end of each of the grappled creature turns, ending the Condition on themself on a success. The Condition also ends if the grappler is Incapacitated, or if any effect forces either the grappler or grappled creature to move (such as a shove attack). Size advantage or disadvantage (listed below) applies.
**If both are the same size**
- The grappled creature's speed is 0. 
- The grappled creature has  Disadvantage on Attack Rolls against any target other than the grappler.
- The grappler cannot move away from the grappled creature without ending the grapple.
...
- The grappled creature has advantage on the saving throw
- The grappled creature has their speed halved. When the grappled, larger creature moves, the grappler moves too.
- The grappler counts as occupying the nearest unoccupied part of the grappled creature's space. If the grappler ends the grapple _willingly_, they choose a space within 5 ft. (or the nearest unoccupied space) to move to.
...
- you take damage while having the surprised condition. You can make a Dexterity or Constitution saving throw with a DC equal to 10 or half the damage, whichever is greater. If you fail the save, you take a wound level.
...
and [Elkan 5e](https://www.elkan5e.com/conditions-1)
