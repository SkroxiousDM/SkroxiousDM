...
Certain features might grant you the option to take an action as a Bonus action, reaction, object interaction, or even no action at all. For instance, the operative’s Cunning Action feature lets them take the Dash, Disengage, or Hide actions as a Bonus action on their turn. Alternatively, you might use your Bonus action to take the Arcane action when you cast a spell with a casting time of one Bonus action. Most Focus features require no action at all, despite using the Focus action.
...
If you want to interact with a second object, draw an item from a backpack container, manipulate an object such as magic item or a complex activity that requires an Ability check, you need to use your action.
...
If an effect increases or decreases your speed, this also affects this additional movement you gain. For instance, if your speed is reduced to 20 feet, you would only gain an additional 20 feet of movement from this action.
...
##Ready
When you take the Ready action, you prepare to act when particular circumstances arise next. Readying an action lets you act using your reaction before the start of your next turn.

First, you choose what circumstances will trigger your Readied action. Second, in response to the trigger, you determine what action you will take or if you will move up to your speed. For instance, you might choose that if a hostile creature comes within 10 feet of you, you will move away from it.
...
If a creature friendly to you deals damage to a creature Taunted by you in this way, the Taunted creature no longer has disadvantage on attack rolls against the friendly creature.
